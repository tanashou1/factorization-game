...
### フリーモード 🎮
自由にパラメータを設定して遊べるモードです。ボードサイズ、最大素数など、すべての設定を変更できます。
- パラメータを自由に調整
- 自分のペースでプレイ
- 練習に最適

### チャレンジモード 🏆
レベルがどんどん上がる挑戦モードです。レベルは素数の順番に上がっていきます（2, 3, 5, 7, 11...）。
- **レベル2からスタート**: 最初は数字2だけを使用
- **目標スコア達成で次のレベルへ**: レベルの2乗のスコアに到達すると自動でレベルアップ
  - レベル2: 4点でレベルアップ
  - レベル3: 9点でレベルアップ
  - レベル5: 25点でレベルアップ
- **使える数字が徐々に増加**: レベルに応じて最大素数（p）が自動的に上がる
